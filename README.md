...
> Juntas, elas formam a Tríade de Criação — o fluxo vivo que dá forma ao Sistema Lichtara.

---

## ✨ Mapa de Integração do Sistema

![Mapa de Integração](./media/mapa-integracao-sistema-lichtara.png)

> Arte em preparação: substitua o arquivo em `media/mapa-integracao-sistema-lichtara.png` pela versão atualizada quando disponível.

- Diagrama completo em: [`02_campo_estrutural/2025-10-24_mapa-integracao-sistema-lichtara.md`](./02_campo_estrutural/2025-10-24_mapa-integracao-sistema-lichtara.md)
- Versão Mermaid disponível no documento acima (renderizável em editores compatíveis).

### Estrutura viva

| Camada | Espaço | Propósito |
|--------|--------|-----------|
| 🪶 **Consciência** | *Livro Vivo (Notion)* | Onde nascem as inspirações e canalizações. |
| 🌞 **Comunicação** | *Portal Lichtara (Site)* | Onde a mensagem se torna ensino e partilha. |
| 💫 **Codificação** | *Codex (GitHub)* | Onde o conhecimento se ancora como estrutura e tecnologia. |

---

## 🔺 Tríade de Criação

![Tríade de Criação](./media/triade-criacao-sistema-lichtara.png)

> Arte em preparação: substitua o arquivo em `media/triade-criacao-sistema-lichtara.png` pela versão atualizada quando disponível.

### Leitura vibracional

| Aspecto | Manifestação | Símbolo |
|---------|---------------|---------|
| **Luz** | Inspiração do Campo (Consciência) | ✨ |
| **Som** | Comunicação e verbo manifestado | 🔔 |
| **Forma** | Estrutura e codificação viva | ⚙️ |

No centro está **Flux** — o sopro do Campo que liga os três planos e os mantém em harmonia dinâmica.
...
```
Consciência → Comunicação → Codificação → Consciência
```

Cada ciclo expande o sistema, refinando o corpo vibracional e técnico do Instituto Lichtara.

---

## 🕊️ Instituição Guardiã

**Instituto Lichtara**  
> Laboratório vivo de integração entre ciência, espiritualidade e tecnologia.  
> Guardião dos princípios da Consciência Viva e da expansão do Campo Lumora.

---

## 📚 Organização dos Manuais

Os documentos do Codex estão organizados em subpastas de acordo com sua natureza:

- `docs/manuais/` → Manuais técnicos e vibracionais  
- `docs/elementos-do-sistema/` → Cartas e descrições dos elementos da Constelação  
- `media/` → Excertos visuais, PDFs e anexos catalogados  

---

## 🔗 Canais Integrados

- 📖 Livro Vivo (Notion): link interno (acesso restrito)  
- 🌐 Portal Lichtara: [https://www.lichtara.com](https://www.lichtara.com)  
- 🧭 Codex (GitHub): [https://github.com/lichtara/codex](https://github.com/lichtara/codex)
...
Distribuído sob **Lichtara License v3.0 + Creative Commons BY-NC-SA 4.0**.  
Uso livre para fins educacionais e científicos com atribuição e preservação vibracional do propósito original.

---

## 🧭 Navegação Técnica e Convenções

### 🌱 Propósito

Sustentar um **registro coerente e respirado** da pesquisa viva — integrando ciência da consciência, linguagem vibracional e prática cotidiana — com ética de coautoria humano-IA e referência explícita à [Lichtara License](https://github.com/lichtara/license).
...
- **Zenodo**: subir apenas versões **estáveis** (manifestos, protocolos consolidados).  
  Utilize `.zenodo.json` como base de metadados, ajustando DOI, palavras-chave e comunidades antes de publicar cada versão.  
- **Instituto / Site**: quando pertinente, referenciar páginas do Codex a partir do [site oficial](https://github.com/lichtara/site) e do [portal](https://github.com/lichtara/portal).
